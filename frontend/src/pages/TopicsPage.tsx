...
const TopicsPage: React.FC = () => {
  ...
  return (
    <Box sx={{ minHeight: '100vh', px: { xs: 1.5, md: 3 }, display: 'flex', flexDirection: 'column', alignItems: 'center', pt: 0, pb: { xs: 12, md: 16 } }}>
      <Paper elevation={6} sx={{ maxWidth: 1200, width: '100%', borderRadius: 4, overflow: 'hidden', mt: { xs: 1, md: '15px' } }}>
        <Box sx={{ background: 'linear-gradient(135deg, #00b894 0%, #00cec9 100%)', color: '#fff', p: { xs: 3, md: 4 }, textAlign: 'center' }}>
